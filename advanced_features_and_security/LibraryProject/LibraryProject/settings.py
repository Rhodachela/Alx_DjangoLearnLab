...
SECRET_KEY = 'django-insecure-#kfdi0c(s2v$ocn)@us40oj+8b(%kimirx9y2f_*c=f@b#x233'
...
# Enable protections against XSS, clickjacking, and MIME sniffing
...
CSP_DEFAULT_SRC = ["'self'"]  # Allow content only from this domain
